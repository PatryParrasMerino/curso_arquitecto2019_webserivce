...
public class ConfiguracionOauth2 extends AuthorizationServerConfigurerAdapter {
    ...
    private String jwtSigningKey; //clave simétrica que ambos servidores deben conocer
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        ...
        clients.inMemory()
                .withClient("userserver") //credenciales para acceder al seervidor de autenticación
                .secret(passwordEncoder().encode("pwdserver")) //credenciales para acceder al seervidor de autenticación
