...
public class ConfiguracionSeguridad extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable()
		.authorizeRequests()
		.antMatchers(HttpMethod.GET,"/lista").hasRole("ADMIN") //para el método get de lista, usuario admin
		.antMatchers("/lista").authenticated()	               //el resto de lista para los autenticados
		//.antMatchers("/**").authenticated() //Todos los autenticados tienen derechos
		.and()
		.httpBasic();
